...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Carl Justine Mosquida - Software Engineer</title>
      </Head>
          ...
          <div className=" col-span-3">
            <div className="grid grid-cols-3 gap-10">
              ...
              <div
                ...
                data-aos-duration="1500"
              >
                <small className="pl-8 text-gray-400">
                  Publishing Platform
                </small>
              ...
              <div className="col-span-2">
                <p
                  className="pt-6 text-sm leading-6"
                  data-aos="fade-left"
                  data-aos-delay="1200"
                  data-aos-duration="1500"
                >
                  ...
                  iusto aspernatur illo impedit culpa sapiente, mollitia
                  expedita sint eveniet? Blanditiis?
                </p>
              </div>
              ...
              <div className="col-span-2 text-sm">
                <p
                  className="pt-11 text-sm leading-6"
                  data-aos="fade-left"
                  data-aos-delay="1600"
                  data-aos-duration="1500"
                >
